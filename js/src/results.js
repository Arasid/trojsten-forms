...
class TableHeader extends React.Component{
    ...
    render() {
        ...
        for (let i = 0; i<this.props.list.length; ++i) {
            let q_id = this.props.list[i]
            let question = this.props.data[q_id]
            let node
    ...
    render() {
        ...
        for (let user in this.props.answers_data) {
            ...
            for (let i = 0; i<this.props.question_list.length; ++i) {
                let q_id = this.props.question_list[i]
                let question = this.props.questions_data[q_id]
                let answer = answers[q_id]
...
class FormResults extends React.Component{
    ...
    loadFormFromServer() {
        ...
        $.when(firstPromise, secondPromise, thirdPromise).done(function(firstData, secondData, thirdData) {
            let data, question_list = [], answers_data = {}, questions_data = {}
